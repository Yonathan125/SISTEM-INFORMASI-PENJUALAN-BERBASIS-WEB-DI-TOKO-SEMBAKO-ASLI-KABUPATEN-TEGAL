...
<body>
    ...
    ?>
        ...
        if(isset($_POST['search'])) {
            ...
            $query = "SELECT * FROM transaksi WHERE id LIKE '%$inputan%' WHERE no_resi IS NOT NULL";
        } else {
            $query = "SELECT * FROM transaksi WHERE no_resi IS NOT NULL";
        }
